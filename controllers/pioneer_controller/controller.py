...
class Device(_object):
    ...
    __swig_getmethods__["hasType"] = lambda x: _controller.Device_hasType
    if _newclass:
...
class Camera(Device):
    ...
    __swig_getmethods__["imageGetGray"] = lambda x: _controller.Camera_imageGetGray
    if _newclass:
...
class GPS(Device):
    ...
    __swig_getmethods__["convertToDegreesMinutesSeconds"] = lambda x: _controller.GPS_convertToDegreesMinutesSeconds
    if _newclass:
...
class InertialUnit(Device):
    ...
    def __internalGetLookupTableSize(self):
        return _controller.InertialUnit___internalGetLookupTableSize(self)

    def getLookupTable(self):
        return _controller.InertialUnit_getLookupTable(self)
...
class RangeFinder(Device):
    ...
    __swig_getmethods__["rangeImageGetValue"] = lambda x: _controller.RangeFinder_rangeImageGetValue
    if _newclass:
        rangeImageGetValue = staticmethod(_controller.RangeFinder_rangeImageGetValue)
    __swig_getmethods__["rangeImageGetDepth"] = lambda x: _controller.RangeFinder_rangeImageGetDepth
    if _newclass:
...
class Speaker(Device):
    ...
    __del__ = lambda self: None
    __swig_getmethods__["playSound"] = lambda x: _controller.Speaker_playSound
    if _newclass:
...
class Robot(_object):
    ...
    __swig_getmethods__["__internalGetDevice"] = lambda x: _controller.Robot___internalGetDevice
    if _newclass:
        __internalGetDevice = staticmethod(_controller.Robot___internalGetDevice)
    __swig_getmethods__["__internalGetDeviceTypeFromTag"] = lambda x: _controller.Robot___internalGetDeviceTypeFromTag
    if _newclass:
        __internalGetDeviceTypeFromTag = staticmethod(_controller.Robot___internalGetDeviceTypeFromTag)
    __swig_getmethods__["__internalGetDeviceNameFromTag"] = lambda x: _controller.Robot___internalGetDeviceNameFromTag
    if _newclass:
        __internalGetDeviceNameFromTag = staticmethod(_controller.Robot___internalGetDeviceNameFromTag)
    __swig_getmethods__["__internalGetDeviceTagFromIndex"] = lambda x: _controller.Robot___internalGetDeviceTagFromIndex
    if _newclass:
        __internalGetDeviceTagFromIndex = staticmethod(_controller.Robot___internalGetDeviceTagFromIndex)
    __swig_getmethods__["__internalGetDeviceTagFromName"] = lambda x: _controller.Robot___internalGetDeviceTagFromName
    if _newclass:

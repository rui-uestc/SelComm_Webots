...
class Pedestrian (Supervisor):
    ...
    def run(self):
        ...
        opt_parser.add_option("--trajectory", default="0 3, 0 -3", help="Specify the trajectory in the format [x1 y1, x2 y2, ...]")
        # opt_parser.add_option("--speed", type=float, default=1, help="Specify walking speed in [m/s]")
        ...
        while not self.step(self.time_step) == -1:
            ...
            # print('root_translation',root_translation)

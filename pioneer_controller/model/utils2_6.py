...
def get_init_pose(index):
    # init_pose_list = [ [-2.5, -18.5, np.pi/2],
    ...
    # init_pose_list = [[-4.5, -6.0, np.pi / 2],[-2.7, -6.0, np.pi / 2],[-0.9, -6.0, np.pi / 2],[0.9, -6.0, np.pi / 2],[2.7, -6.0, np.pi / 2],
    #                   [4.5, -6.0, np.pi / 2],[-4.5, 6.0, 3*np.pi / 2],[-2.7, 6.0, 3*np.pi / 2],[-0.9, 6.0, 3*np.pi / 2],[0.9, 6.0, 3*np.pi / 2],
    #                   [2.7, 6.0, 3*np.pi / 2],[4.5, 6.0, 3*np.pi / 2]]    12robots
    # init_pose_list = [[-5, -6.0, np.pi / 2],[-4, -6.0, np.pi / 2],[-3, -6.0, np.pi / 2],[-2, -6.0, np.pi / 2],[-1, -6.0, np.pi / 2],
    #                   [0, -6.0, np.pi / 2],[1, -6.0, np.pi / 2],[2, -6.0, np.pi / 2],[3, -6.0, np.pi / 2],[4, -6.0, np.pi / 2],[5, -6.0, np.pi / 2],
    #                   [-5, 6.0, 3*np.pi / 2],[-4, 6.0, 3*np.pi / 2],[-3, 6.0, 3*np.pi / 2],[-2, 6.0, 3*np.pi / 2],[-1, 6.0, 3*np.pi / 2],
    #                   [0, 6.0, 3*np.pi / 2],[1, 6.0, 3*np.pi / 2],[2, 6.0, 3*np.pi / 2],[3, 6.0, 3*np.pi / 2],[4, 6.0, 3*np.pi / 2],[5, 6.0, 3*np.pi / 2]]
    # init_pose_list = [[-5, -6.0, np.pi / 2],[-3.75, -6.0, np.pi / 2],[-2.5, -6.0, np.pi / 2],[-1.25, -6.0, np.pi / 2],
    #                   [0, -6.0, np.pi / 2],[1.25, -6.0, np.pi / 2],[2.5, -6.0, np.pi / 2],[3.75, -6.0, np.pi / 2],[5, -6.0, np.pi / 2],
    #                   [-5, 6.0, 3*np.pi / 2],[-3.75, 6.0, 3*np.pi / 2],[-2.5, 6.0, 3*np.pi / 2],[-1.25, 6.0, 3*np.pi / 2],
    #                   [0, 6.0, 3*np.pi / 2],[1.25, 6.0, 3*np.pi / 2],[2.5, 6.0, 3*np.pi / 2],[3.75, 6.0, 3*np.pi / 2],[5, 6.0, 3*np.pi / 2]]
    # init_pose_list = [[-6, -6.0, np.pi / 2],[-4.5, -6.0, np.pi / 2],[-3.0, -6.0, np.pi / 2],[-1.5, -6.0, np.pi / 2],
    #                   [0, -6.0, np.pi / 2],[1.5, -6.0, np.pi / 2],[3.0, -6.0, np.pi / 2],[4.5, -6.0, np.pi / 2],[6, -6.0, np.pi / 2],
    #                   [-6, 6.0, 3*np.pi / 2],[-4.5, 6.0, 3*np.pi / 2],[-3.0, 6.0, 3*np.pi / 2],[-1.5, 6.0, 3*np.pi / 2],
    #                   [0, 6.0, 3*np.pi / 2],[1.5, 6.0, 3*np.pi / 2],[3.0, 6.0, 3*np.pi / 2],[4.5, 6.0, 3*np.pi / 2],[6, 6.0, 3*np.pi / 2]]
    init_pose_list = [[-3.75, -5.0, np.pi / 2],[-2.25, -5.0, np.pi / 2],[-0.75, -5.0, np.pi / 2],[0.75, -5.0, np.pi / 2],
                      [2.25, -5.0, np.pi / 2],[3.75, -5.0, np.pi / 2],
                      [-3.75, 5.0, 3*np.pi / 2],[-2.25, 5.0, 3*np.pi / 2],[-0.75, 5.0, 3*np.pi / 2],[0.75, 5.0, 3*np.pi / 2],
                      [2.25, 5.0, 3*np.pi / 2],[3.75, 5.0, 3*np.pi / 2]]
    return init_pose_list[index]

def get_goal_point(index):
    # goal_list = [
    #               [-2.5, -5.5], [-0.5, -5.5], [1.5, -5.5], [3.5, -5.5], [5.5, -5.5],
    #              [-18.0, -10.0], [-16.85, -13.53], [-13.85, -15.71], [-10.15, -15.71], [-7.15, -13.53], [-6.00, -10.00],
    #              [-7.15, -6.47], [-10.15, -4.29], [-13.85, -4.29], [-16.85, -6.47],
    #              ]
    # goal_list = [[-4.5, 6.0],[-2.7, 6.0],[-0.9, 6.0],[0.9, 6.0],[2.7, 6.0],[4.5, 6.0],
    #              [-4.5, -6.0],[-2.7, -6.0],[-0.9, -6.0],[0.9, -6.0],[2.7, -6.0],[4.5, -6.0]]
    # goal_list = [[-5, 6.0], [-4, 6.0], [-3, 6.0], [-2, 6.0], [-1, 6.0], [0, 6.0],[1, 6.0], [2, 6.0], [3, 6.0], [4, 6.0], [5, 6.0],
    #              [-5, -6.0], [-4, -6.0], [-3, -6.0], [-2, -6.0], [-1, -6.0], [0, -6.0],[1, -6.0], [2, -6.0], [3, -6.0], [4, -6.0], [5, -6.0]]
    goal_list = [[-3.75, 5.0], [-2.25, 5.0], [-0.75, 5.0], [0.75, 5.0],[2.25, 5.0], [3.25, 5.0],
                 [-3.25, -5.0], [-2.25, -5.0], [-0.75, -5.0], [0.75, -5.0],[2.25, -5.0], [3.75, -5.0]]
    return goal_list[index]
...
#     return filter_index
def get_filter_index(d_list):   # if a certain robot reach the goal or crash early, the subsequent sample is not used for update
    filter_index = []
    filter_flag = 0
    step = d_list.shape[0]
    num_env = d_list.shape[1]
    for i in range(num_env):
        for j in range(step):
            ...
            if filter_flag >= 2:
                #filter_index.append(num_env*j + i)
                filter_index.append((j,i))
    return filter_index


def get_group_terminal(terminal_list, index):
    group_terminal = False
    refer = [0, 12, 23, 24, 25, 26, 34, 44]

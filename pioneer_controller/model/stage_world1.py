...
class StageWorld():
    ...
    def generate_random_pose(self):
        ...
        while(True) and not rospy.is_shutdown():
            ...
            y = np.random.uniform(-9, 9)
            #print([x, y])
            # if x<-12 and y>10 and y<13:
            #     near_obstacle = True
            # if x > -2 and x < 1 and y > 12:
            #     near_obstacle = True
            # if x>5 and x<14 and y>9 and y<13:
            #     near_obstacle = True
            # if x>-10 and x<0 and y>1 and y<4:
            #     near_obstacle = True
            # if x>-12 and y>-3 and y<0:
            #     near_obstacle = True
            # if x>-13 and x<-9 and y>-12 and y<3:
            #     near_obstacle = True
            # if x > -2 and x < 7 and y > -12 and y < -8:
            #     near_obstacle = True
            # if x > 12 and x < 16 and y<-12:
            #     near_obstacle = True
            '''obstacle_rink
            if x<-5 and y>4 and y<6:
                near_obstacle = True
            if x > -3 and x < -1 and y > 5.5:
                near_obstacle = True
            if x>1 and x<7 and y>3 and y<5:
                near_obstacle = True
            if x>-5 and x<0 and y>0 and y<2:
                near_obstacle = True
            if x > -5 and x < -3 and y > -6 and y < -2:
                near_obstacle = True
            if x>4 and y>-3 and y<-1:
                near_obstacle = True
            if x > 1.5 and x < 3.5 and y < -6:
                near_obstacle = True
            '''
            # obstacle_rink_easy
            # if x > -6.5 and x<-3 and y>3 and y<5:
            #     near_obstacle = True
            # if x > -0.5 and x < 1.5 and y>5 and y<8:
            #     near_obstacle = True
            # if x>3.5 and x<7 and y>3 and y<5:
            #     near_obstacle = True
            # if x>-3 and x<0.5 and y>-1 and y<1:
            #     near_obstacle = True
            # if x > -5.5 and x < -3.5 and y > -6 and y < -3:
            #     near_obstacle = True
            # if x>4.5 and x < 8 and y>-3.5 and y<-1.5:
            #     near_obstacle = True
            # if x > 1.5 and x < 3.5 and y < -7:
            #     near_obstacle = True
            # dis = np.sqrt(x ** 2 + y ** 2)
            # if near_obstacle is False and dis<9:
            #     break

            # if x > 1 - 0.8 and x < 1 + 0.8 and y > -8 - 0.8 and y < -8 + 0.8:
            #     near_obstacle = True
            # if x > 3 - 0.8 and x < 3 + 0.8 and y > 6 - 0.8 and y < 6 + 0.8:
            #     near_obstacle = True
            # if x > 2 - 0.8 and x < 2 + 0.8 and y > -4 - 0.8 and y < -4 + 0.8:
            #     near_obstacle = True
            # if x > 6 - 0.8 and x < 6 + 0.8 and y > 1 - 0.8 and y < 1 + 0.8:
            #     near_obstacle = True
            # if x > -2 - 0.8 and x < -2 + 0.8 and y > 7 - 0.8 and y < 7 + 0.8:
            #     near_obstacle = True
            # if x > -7 - 0.8 and x < -7 + 0.8 and y > -1 - 0.8 and y < -1 + 0.8:
            #     near_obstacle = True
            # if x > 0 - 0.8 and x < 0 + 0.8 and y > 0 - 0.8 and y < 0 + 0.8:
            #     near_obstacle = True
            # if x > -2 - 0.8 and x < -2 + 0.8 and y > 2 - 0.8 and y < 2 + 0.8:
            #     near_obstacle = True

            if x > 0 - 0.8 and x < 0 + 0.8 and y > 0 - 0.8 and y < 0 + 0.8:
                near_obstacle = True

            dis = np.sqrt(x ** 2 + y ** 2)  # zhe shi kai fang yun suan
            if near_obstacle is False and dis<9:
                break
        theta = np.random.uniform(0, 2 * np.pi)
    ...
    def generate_random_goal(self):
        ...
        proper_origin = False
        proper_goal = False
        while (not proper_origin or not proper_goal or near_obstacle) and not rospy.is_shutdown():
            near_obstacle = False
            proper_origin = True
            proper_goal = True
            x = np.random.uniform(-9, 9)
